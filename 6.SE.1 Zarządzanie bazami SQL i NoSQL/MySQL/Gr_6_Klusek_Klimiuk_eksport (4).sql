...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2025 at 04:11 PM
...
CREATE TABLE `end_survey` (
  ...
  `was_tracking_sleep` tinyint(1) NOT NULL,
  `amount_of_sleep` int(11) DEFAULT NULL,
  `was_tracking_nutrition` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `excercises_in_training`
--

INSERT INTO `excercises_in_training` (`excercise_id`, `repetitions`, `sets`, `weight`, `training_day_id`, `effort_type_id`) VALUES
(1, 5, 5, 90, 1, 2),
(1, 2, 3, 110, 9, 2),
(1, 5, 3, 82.5, 11, 4),
(1, 5, 3, 95, 13, 3),
...
--
-- Dumping data for table `executed_sets`
--

INSERT INTO `executed_sets` (`id`, `excercise_id`, `executed_repetitions`, `weight_used`, `training_day_id`) VALUES
(1, 1, 5, 90, 1),
(2, 1, 5, 90, 1),
(3, 1, 4, 90, 1),
(4, 1, 5, 90, 1),
...
INSERT INTO `training_day` (`id`, `training_plan_id`, `week_day`, `week`) VALUES
(1, 1, 'Monday', 1),
(2, 1, 'Tuesday', 1),
(3, 1, 'Wednesday', 1),
(4, 1, 'Thursday', 1),
...
(3, 'user3', 'pass3', 'user3@gmail.com', 1, '2025-03-26 10:44:51');
...
INSERT INTO `user_records` (`user_id`, `max_squat`, `max_bench`, `max_deadlift`) VALUES
(1, 120, 135, 140),
(2, 100, 150, 85),
(3, 50, 50, 50);
...
INSERT INTO `user_stats` (`user_id`, `plans_completed`, `trainings_completed`, `sets_completed`, `total_tonnage`) VALUES
(1, 2, 15, 30, 10),
(2, 1, 5, 30, 0.5),
(3, 0, 1, 5, 0.1);
...
--
-- AUTO_INCREMENT for table `executed_sets`
--
ALTER TABLE `executed_sets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `training_day`
--
ALTER TABLE `training_day`
